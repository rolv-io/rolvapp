---
title: "Rolv Desktop Documentation (v1.2.0)"
date: "2025-10-17"
output:
  html_document:
    toc: true
...
For windows installation, you should download a file named __rolvdesktop-1.2.0 Setup.exe__.Now, let’s walk through the steps to install _rolv_ desktop app:

1. Locate the __rolvdesktop-1.2.0 Setup.exe__ file on your computer.
...
2. Move to the directory in which you downloaded rolvdesktop_1.2.0_amd64.deb. This can be done by:
...
```bash
sudo apt install ./rolvdesktop_1.2.0_amd64.deb
```
...
2. Move to the directory in which you downloaded __rolvdesktop-1.2.0-1.x86_64.rpm__. This can be done by:
...
3. Run the following command and fill in your system password:
```bash
sudo rpm -ivh ./rolvdesktop-1.2.0-1.x86_64.rpm
```
