...
For windows installation, you should download a file named __rolvdesktop-1.0.0 Setup.exe__.Now, let’s walk through the steps to install _rolv_ desktop app:
...
a file named rolvdesktop_1.0.0_amd64.deb.  Now, let’s walk through the steps to install _rolv_ desktop app:
...
a file named __rolvdesktop-1.0.0-1.x86_64.rpm__.Now, let’s walk through the steps to install RolvDesktop:
...
The new versions are released via github releases.
...
## Bug Reports: Template for submitting issues.

## Feature Requests: Process for suggesting improvements.

# Updates & Maintenance
Auto-Update: How the app handles updates (if applicable).

Manual Update: Instructions for downloading new versions.
