---
title: "Rolv Desktop Documentation (v2.0.0)"
date: "2025-11-11"
output:
  html_document:
    toc: true
...
For windows installation, you should download a file named __rolvdesktop-2.0.0 Setup.exe__.Now, let’s walk through the steps to install _rolv_ desktop app:

1. Locate the __rolvdesktop-2.0.0 Setup.exe__ file on your computer.
...
#### Mac OS
For mac os, you should download the file called `rolvdesktop-darwin-x64-2.0.0.zip`.
Afterwards, follow the steps below:

1. Move the rolvdesktop-darwin-x64-2.0.0.zip file to the directory where you want it to be installed.
...
a file named rolvdesktop_2.0.0_amd64.deb.  Now, let’s walk through the steps to install _rolv_ desktop app:

1. Open the terminal ( press Ctrl + Alt + T or search for ‘Terminal’ in your applications menu)

2. Move to the directory in which you downloaded rolvdesktop_2.0.0_amd64.deb. This can be done by:
...
```bash
sudo apt install ./rolvdesktop_2.0.0_amd64.deb
```
...
a file named __rolvdesktop-2.0.0-1.x86_64.rpm__.Now, let’s walk through the steps to install RolvDesktop:

1. Open the terminal ( press Ctrl + Alt + T or search for ‘Terminal’ in your applications menu)

2. Move to the directory in which you downloaded __rolvdesktop-2.0.0-1.x86_64.rpm__. This can be done by:
...
3. Run the following command and fill in your system password:
```bash
sudo rpm -ivh ./rolvdesktop-2.0.0-1.x86_64.rpm
```
